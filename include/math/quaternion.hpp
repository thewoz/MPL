...
#ifndef _H_MPL_GEOMETRY_QUATERNION_H_
#define _H_MPL_GEOMETRY_QUATERNION_H_
...
namespace mpl::geometry {
    ...
    union quaternion_t {
      ...
      bool check() const { return fabs((q4*q4)+(q1*q1)+(q2*q2)+(q3*q3)-1) > 1.0e-08; }
...
#endif // _H_MPL_GEOMETRY_QUATERNION_H_
