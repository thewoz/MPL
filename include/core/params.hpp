...
#ifndef _H_MPL_CLI_PARAMS_H_
#define _H_MPL_CLI_PARAMS_H_
...
//  };
  ...
  typedef param_t<cv::Size>    size2d_t;
  ...
  template <class T>
  class range_param_t : public param_t<T> {
  ...
  public:
    ...
    range_param_t(T defaultValue, T min, T max) {
  ...
  typedef range_param_t<int>    int_range_t;
  typedef range_param_t<double> real_range_t;
  ...
  public:
    ...
    T min(const std::string & key){
      ...
      try {
        ...
        return ((range_param_t<T> *)(param))->min();
        
      } catch (std::out_of_range) {
        
        fprintf(stderr, "mpl::params_t::get() error: parameter '%s' not found\n", key.c_str());
        abort();
    ...
    T max(const std::string & key){
      ...
      try {
        ...
        return ((range_param_t<T> *)(param))->max();
    ...
    bool check(const std::string & key){
      ...
      try {
        ...
        return ((range_param_t<T> *)(param))->get();
...
int & setIntParam(std::string key){
  ...
  try {
    ...
    fprintf(stderr, "mpl::setIntParam() error: parameter '%s' not found in algorithm '%s'\n", key.c_str(), name.c_str());
    abort();
...
double & setRealParam(std::string key){
  ...
  try {
    ...
    fprintf(stderr, "mpl::setRealParam() error: parameter '%s' not found in algorithm '%s'\n", key.c_str(), name.c_str());
    abort();
...
bool & setBoolParam(std::string key){
  ...
  try {
    ...
    fprintf(stderr, "mpl::setBoolParam() error: parameter '%s' not found in algorithm '%s'\n", key.c_str(), name.c_str());
    abort();
...
cv::Mat & setImageParam(std::string key){
  ...
  try {
    ...
    fprintf(stderr, "mpl::setImageParam() error: parameter '%s' not found in algorithm '%s'\n", key.c_str(), name.c_str());
    abort();
...
cv::Mat getImageParam(std::string key){
  ...
  try {
    ...
    fprintf(stderr, "mpl::getImageParam() error: parameter '%s' not found in algorithm '%s'\n", key.c_str(), name.c_str());
    abort();
...
std::string & setStringParam(std::string key){
  ...
  try {
    ...
    fprintf(stderr, "mpl::setStringParam() error: parameter '%s' not found in algorithm '%s'\n", key.c_str(), name.c_str());
    abort();
...
std::string & setOptionsParam(std::string key){
  ...
  try {
    ...
    fprintf(stderr, "mpl::setOptionsParam() error: parameter '%s' not found in algorithm '%s'\n", key.c_str(), name.c_str());
    abort();
